        ...
        <div class="row">
            <div class="col-lg-3 bg-secondary d-none d-lg-block">
                <a href="" class="navbar-brand w-100 h-100 m-0 p-0 d-flex align-items-center justify-content-center">
                    <h1 class="m-0 display-3 text-primary">Donation</h1>
                </a>
            </div>
            <div class="col-lg-9">
                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
                    <a href="" class="navbar-brand d-block d-lg-none">
                        <h1 class="m-0 display-4 text-primary">Donation</h1>
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <a href="Donation.jsp" class="btn btn-primary mr-3 d-none d-lg-block">Donate</a>
                    </div>
                </nav>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-end mb-4">
                <div class="col-lg-6">
                    ...
                    <h1 class="section-title mb-3">Projects</h1>
                </div>
            ...
            <div class="row m-0 portfolio-container">
                <div class="col-lg-4 col-md-6 col-sm-12 p-0 portfolio-item first">
                    <div class="position-relative overflow-hidden">
                        <div class="portfolio-img" style="width: 350px; height: 350px;">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 p-0 portfolio-item third">
                    <div class="position-relative overflow-hidden">
                        <div class="portfolio-img" style="width: 300px; height: 300px;">
        ...
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                <a href="index.jsp" class="navbar-brand">
                    <h1 class="m-0 mt-n3 display-4 text-primary">Donation</h1>
                </a>
